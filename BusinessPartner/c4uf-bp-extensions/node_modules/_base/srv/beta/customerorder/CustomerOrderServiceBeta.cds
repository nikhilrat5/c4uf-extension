using {
    ...
    sap.odm.businesspartner as partner
...
service CustomerOrderServiceBeta @(
    path: '/api/beta/customerorder/v2',
    requires: 'authenticated-user',
    version: 'beta',
    impl: 'srv/api/API_EDOM_RETAILER'
) { 
    @(restrict: [
        { grant: ['WRITE'], to: ['API.Write', 'emcallback'] },
    ...
    entity BusinessPartner as projection on partner.BusinessPartner {
        id
    }
    ...
    entity BusinessPartnerAddressData as projection on partner.BusinessPartner.addressData
    {
        up_,
        id
    };
    ...
    entity CompanyCode as projection on orgunit.CompanyCode {
        id,
        displayId,
        name,
        company,
    ...
    entity DeviceTypeCodes as projection on beta.odm.utilities.sales.DeviceTypeCodes;

    @(restrict: [
        { grant: ['WRITE'], to: 'API.Write'},
        { grant: ['READ'], to: 'API.Read'},
    ])
    entity BudgetBillingTypeCodes as projection on beta.odm.utilities.sales.BudgetBillingTypeCodes;
