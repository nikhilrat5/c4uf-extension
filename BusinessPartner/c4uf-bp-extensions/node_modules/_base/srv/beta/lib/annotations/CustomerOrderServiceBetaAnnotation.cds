using {
  CustomerOrderServiceBeta.CustomerOrder,
  CustomerOrderServiceBeta.Product,
  CustomerOrderServiceBeta.SalesOrganization,
  CustomerOrderServiceBeta.ServiceOrganization,
  CustomerOrderServiceBeta.CompanyCode,
  CustomerOrderServiceBeta.CustomerOrderTypeCodes,
  CustomerOrderServiceBeta.CustomerOrderReasonCodes,
  CustomerOrderServiceBeta.CustomerOrderItemTypeCodes,
  CustomerOrderServiceBeta.CustomerOrderItemUtilitiesSubsequentDocumentCodes,
  CustomerOrderServiceBeta.SalesCancellationStatusCodes,
  CustomerOrderServiceBeta.SalesCancellationReasonCodes,
  CustomerOrderServiceBeta.SalesProcessingStatusCodes,
  CustomerOrderServiceBeta.SalesPartnerRoleCodes,
  CustomerOrderServiceBeta.SalesTextTypeCodes,
  CustomerOrderServiceBeta.DistributionChannelCodes,
  CustomerOrderServiceBeta.ConditionTypeCodes,
  CustomerOrderServiceBeta.DivisionCodes,
  CustomerOrderServiceBeta.ServiceOrderPriorityCodes,
  CustomerOrderServiceBeta.ShippingConditionCodes,
  CustomerOrderServiceBeta.DeliveryPriorityCodes,
  CustomerOrderServiceBeta.UnitOfMeasuresCodes,
  CustomerOrderServiceBeta.CurrencyCodes,
  CustomerOrderServiceBeta.PaymentTermCodes,
  CustomerOrderServiceBeta.PaymentCardTypeCodes,
  CustomerOrderServiceBeta.LanguageCodes,
  CustomerOrderServiceBeta.CountryCodes,
  CustomerOrderServiceBeta.IncotermsClassificationCodes,
  CustomerOrderServiceBeta.DeviceTypeCodes,
  CustomerOrderServiceBeta.BudgetBillingTypeCodes
} from './../../customerorder/CustomerOrderServiceBeta';
...
annotate CustomerOrder with @Capabilities: {
    ...
    NavigationRestrictions: {
        RestrictedProperties : [
        {
            ...
            ReadRestrictions : {  
                Description: 'Retrieves alternative country of customer order item partner.', 
                LongDescription: 'Retrieves alternative country of a single customer order item partner with a specific identifier.'      
            },
            DeleteRestrictions : {
                Deletable : false
            }
            ...
            ReadRestrictions : {       
                Description: 'Retrieves alternative country of customer order partner.', 
                LongDescription: 'Retrieves alternative country of a single customer order partner with a specific identifier.'  
            },
            DeleteRestrictions : {
                Deletable : false
            }
...
annotate SalesOrganization with @Capabilities: {
    ...
    InsertRestrictions: {
        ...
        LongDescription: 'Creates a single sales organization where a sales organization is responsible for the sale and distribution of goods and services in one particular country.'
    },
    DeleteRestrictions: {
        Deletable : false
    },
...
annotate CountryCodes with @Capabilities: {
    ReadRestrictions: {
        ...
        LongDescription: 'Retrieves a list of country codes.',
        ReadByKeyRestrictions: {
            Description: 'Retrieves country/region code.',
            LongDescription: 'Retrieves a single country for the given code.'
        }
    },
    UpdateRestrictions: {
        Description: 'Updates country code.',
        LongDescription: 'Updates a single country for the given code.'
    },
    InsertRestrictions: {
        Description: 'Creates country code.',
        LongDescription: 'Creates a single country code. Country codes following IES ISO-3166 ALPHA-2.'
    },
    DeleteRestrictions: {
        Description: 'Deletes country code.',
        LongDescription: 'Deletes a single country for the given code.'
    },
    ...
    NavigationRestrictions: {
        RestrictedProperties : [
        {
            NavigationProperty : currency,
            ReadRestrictions: {
                Description: 'Retrieves currency of a country code.',
                LongDescription: 'Retrieves currency of a country for the given code.'
            }
        }
    ]}
};
...
annotate DeviceTypeCodes with @Capabilities: {
    ReadRestrictions: {
...
annotate BudgetBillingTypeCodes with @Capabilities: {
    ReadRestrictions: {
