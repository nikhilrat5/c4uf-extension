...
annotate CustomerOrder with @Capabilities: {
    ...
    NavigationRestrictions: {
        RestrictedProperties : [
        {
            ...
            ReadRestrictions: {
                Description: 'Retrieves the header level custom references of the customer order item.',
                LongDescription: 'Retrieves a list of all header level custom references for a single customer order item with a specific identifier. The custom references are used for a commodity item and are mapped to a subscription in the subscription billing api.',
                ReadByKeyRestrictions : {
                    Description: 'Retreives a header custom references of a single customer order item.',
                    LongDescription: 'Retreives a header custom references of a single customer order item with a specific identifier. The custom references are used for a commodity item and are mapped to a subscription in the subscription billing api.'
                }
            },
            InsertRestrictions : {
                Description: 'Creates a header custom reference for the customer order item.',
                LongDescription: 'Creates a header custom reference for a single customer order item with a specific identifier.  The custom references are used for a commodity item and are mapped to a subscription in the subscription billing api.'
            },
            DeleteRestrictions : {
                Deletable : false
            }
            ...
            ReadRestrictions: {
                Description: 'Retrieves the item level custom references of the customer order item.',
                LongDescription: 'Retrieves a list of all item level custom references for a single customer order item with a specific identifier. The custom references are used for a commodity item and are mapped to a subscription in the subscription billing api.',
                ReadByKeyRestrictions : {
                    Description: 'Retreives a custom references of a single customer order item.',
                    LongDescription: 'Retreives a custom references of a single customer order item with a specific identifier. The custom references are used for a commodity item and are mapped to a subscription in the subscription billing api.'
                }
            },
            InsertRestrictions : {
                Description: 'Creates a custom reference for the customer order item.',
                LongDescription: 'Creates a custom reference for a single customer order item with a specific identifier.  The custom references are used for a commodity item and are mapped to a subscription in the subscription billing api.'
            },
            DeleteRestrictions : {
                Deletable : false
            }
            ...
            ReadRestrictions: {
                Description: 'Retrieves the item level subscription parameters of the customer order item.',
                LongDescription: 'Retrieves a list of all item level subscription parameters for a single customer order item with a specific identifier. The subscription parameters are used for a commodity item and are mapped to a subscription in the subscription billing api.',
                ReadByKeyRestrictions : {
                    Description: 'Retreives a subscription parameter of a single customer order item.',
                    LongDescription: 'Retreives a subscription parameter of a single customer order item with a specific identifier. The subscription parameters are used for a commodity item and are mapped to a subscription in the subscription billing api.'
                }
            },
            InsertRestrictions : {
                Description: 'Creates a subscription parameter for the customer order item.',
                LongDescription: 'Creates a subscription parameter for a single customer order item with a specific identifier.  The subscription parameters are used for a commodity item and are mapped to a subscription in the subscription billing api.'
            },
            DeleteRestrictions : {
                Deletable : false
            }
